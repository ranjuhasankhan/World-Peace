    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-green-50">
      ...
      <section id="home" className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <div className="flex justify-center mb-6">
              <div className="relative">
                ...
                <Globe className="w-24 h-24 text-blue-600 relative animate-spin-slow" style={{animationDuration: '20s'}} />
              </div>
            </div>
            <h1 className="text-5xl md:text-7xl font-bold text-gray-800 mb-6">
              Building a World of
              <span className="block bg-gradient-to-r from-blue-600 via-green-600 to-blue-600 bg-clip-text text-transparent">
                Peace & Harmony
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <button 
                ...
                className="px-8 py-4 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-full font-semibold hover:shadow-2xl hover:shadow-blue-500/50 transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
              >
          ...
          {/* Peace Counter */}
          <div className="text-center bg-gradient-to-r from-blue-100 to-green-100 rounded-3xl p-8 max-w-md mx-auto shadow-lg">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {initiatives.map((initiative, index) => (
              <div
                key={index}
                className="p-8 bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:scale-105"
              >
                <div className={`bg-gradient-to-r ${initiative.color} w-16 h-16 rounded-2xl flex items-center justify-center text-white mb-4`}>
                  {initiative.icon}
                </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {stories.map((story, index) => (
              ...
              >
                <div className="bg-gradient-to-r from-blue-500 to-green-500 h-48 flex items-center justify-center text-8xl">
                  {story.image}
                </div>
                <div className="p-6">
      ...
      <section id="get-involved" className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 to-green-600">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12">
            <div className="mb-8 p-6 bg-blue-50 rounded-2xl border-l-4 border-blue-600">
              <h3 className="font-semibold text-gray-800 mb-3 text-lg">I pledge to:</h3>
            ...
            <div className="space-y-6">
              ...
              <button
                ...
                className="w-full px-8 py-4 bg-gradient-to-r from-blue-600 to-green-600 text-white rounded-lg font-semibold hover:shadow-2xl transition-all duration-300 transform hover:scale-105 flex items-center justify-center gap-2"
              >
                <Heart className="w-5 h-5" />
                Submit Peace Pledge
              </button>
